...
public class TestDataHelper {
    ...
    public static DataEnvelope createTestDataEnvelopeApiObject() {
        ...
        DataHeader dataHeader = new DataHeader(MD5_CHECKSUM,TEST_NAME, BlockTypeEnum.BLOCKTYPEA);
    ...
    public static DataEnvelope createTestDataEnvelopeApiObjectWithEmptyName() {
        DataBody dataBody = new DataBody(DUMMY_DATA);
        DataHeader dataHeader = new DataHeader(MD5_CHECKSUM,TEST_NAME_EMPTY, BlockTypeEnum.BLOCKTYPEA);
